...
var WelcomePage = /** @class */ (function () {
    function WelcomePage(navCtrl, toastCtrl, translateService, loadingCtrl, formBuilder, viewCtrl, app, user) {
        ...
        this.pages = [
            { title: 'Lista de Atividades ', component: 'UsersPage' }
        ];
        this.account = {
            email: '',
            password: ''
        ...
        this.translateService.get('ERRO').subscribe(function (value) {
            _this.signinErrorString = value;
        });
        this.falsemsg = "Bem vindo !";
    }
    WelcomePage.prototype.signIn = function () {
        var _this = this;
        if (!this.form.valid) {
            var toast = this.toastCtrl.create({
                message: "Email e Senha são necessarios para LOGIN.",
                duration: 3000,
                position: 'top'
            });
            toast.present();
    ...
    WelcomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-welcome',template:/*ion-inline-start:"H:\ionic\RedeEtec\redesEtec\src\pages\welcome\welcome.html"*/'<ion-content scroll="false">\n  <div class="fixed-content">\n    <div class="logoHeader">\n      <img alt="logo" height="135" style="position: relative" src="../assets/img/icon-512x512.jpg">\n    </div>\n    <h1 style="text-align:center;color:  rgb(255, 255, 255);" class="welcomeHeader">Redes ETEC</h1>\n    <form *ngIf="form" [formGroup]="form" (ngSubmit)="signIn()">\n      <div padding>\n        <ion-input type="email"  [(ngModel)]="account.email" class="input-access-code" placeholder="Email" formControlName="user_name"></ion-input>\n        <br>\n        <ion-input type="password" [(ngModel)]="account.password" class="input-access-code" placeholder="Password" formControlName="user_pass"></ion-input>\n        <br>\n        <a href="/#/users_lists">\n          <button ion-button block class="login">{{ \'Entrar\' | translate }}</button>\n        </a>\n        \n        <a href="/#/users_lists">\n          <button ion-button block class="signup" style="padding: 21px !important;"> {{\n            \'FACEBOOK\' |\n            translate }}\n          </button>\n        </a>\n        <div class="create_account">\n          <a style="text-align:center;color:  rgb(255, 255, 255);" href="/#/signup">Nova Conta</a>​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​\n        </div>\n      </div>\n    </form>\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"H:\ionic\RedeEtec\redesEtec\src\pages\welcome\welcome.html"*/
        }),
